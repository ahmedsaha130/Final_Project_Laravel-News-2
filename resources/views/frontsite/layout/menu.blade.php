    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
               <a href='{{ route('index') }}' ><img src="{{ asset('frontcss/images/logo.png') }}" alt="img" class="fh5co_logo_width"/></a>
            </div>
        ...
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    {{--  <li class="nav-item ">
                        <a class="nav-link" href="{{ route('single',1 ) }}">Single <span class="sr-only">(current)</span></a>
                    </li>  --}}
                    ...
                    @guest
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('login') }}">Login Admin  <span class="sr-only">(current)</span></a>
                    </li>
                    @endguest

                    @auth()
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('dashboardadmin') }}">dashboard <span class="sr-only">(current)</span></a>
                    </li>
